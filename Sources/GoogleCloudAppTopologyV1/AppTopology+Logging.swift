...
extension Clients {
  final class AppTopologyLogging: AppTopologyStub {
    let inner: any AppTopologyStub
    let logger: Logger

    public init(_ inner: any AppTopologyStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-apptopology-v1"
      logger[metadataKey: "gcp.client.service"] = "apptopology"
      logger[metadataKey: "gcp.experimental.swift.client"] = "AppTopology"
      self.inner = inner
      self.logger = logger
    }
    ...
    public func generateDiscoveredResourcesTopology(
      ...
      try await self._intercept(
        request: request,
        options: options,
        name: "generateDiscoveredResourcesTopology",
        action: {
          (r: GenerateDiscoveredResourcesTopologyRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleCloudAppTopologyV1.GenerateDiscoveredResourcesTopologyResponse
          in
          return try await self.inner.generateDiscoveredResourcesTopology(request: r, options: o)
        })
    }
      ...
      try await self._intercept(
        ...
        action: {
          (r: GetSchemaRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleCloudAppTopologyV1.Schema
          in
      ...
      try await self._intercept(
        ...
        action: {
          (r: GetDomainRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleCloudAppTopologyV1.Domain
          in
